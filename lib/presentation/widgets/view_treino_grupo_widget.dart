...
class _ViewTreinoGrupoWidgetState extends State<ViewTreinoGrupoWidget> {
  ...
  // Variáveis para controle do arquivo da imagem
  ...
  // Função para selecionar a foto .png do treino pago
            ...
            child: Column(
              ...
              children: [
                ...
                _secaoTexto(
                  ...
                  treino['descricao_treino'] ?? 'Nenhuma descrição fornecida.',
                ...
                _secaoTexto(
                  ...
                  treino['plano_alimentar'] ??
                      'Nenhum plano alimentar associado.',
                ...
                // =========================================================================
                // SEÇÃO DE SELEÇÃO DA FOTO DO TREINO PAGO (.PNG)
                // =========================================================================
                const Text(
                  "COMPROVANTE DO TREINO (OPCIONAL)",
                  style: TextStyle(
                    color: Colors.grey,
                    fontSize: 10,
                    fontWeight: FontWeight.bold,
                ...
                InkWell(
                  onTap: _carregandoImagem ? null : _selecionarComprovante,
                        ...
                        : Row(
                            ...
                            children: [
                              ...
                              Expanded(
                                child: Text(
                                  _nomeArquivo ??
                                      "Anexar foto do Treino Pago (.png)",
                                  style: TextStyle(
                                    color: _imagemBytes != null
                                        ? Colors.green
                                        : Colors.white30,
                    ...
                    onPressed: _isFinalizando
                        ...
                        : () async {
                            ...
                            try {
                              ...
                              // Se o aluno escolheu uma foto, faz o upload primeiro
                              if (_imagemBytes != null &&
                                  _nomeArquivo != null) {
                                urlFotoPublica = await repository
